...
export const defaultAvatarConfig: Required<AvatarConfig> = {
    avatarStyle: 'Circle',
...
export const canvasBackgrounds = [
    'SkyBlue', 'SoftMint', 'Lavender', 'WarmWhite', 'Peach', 'Slate', 'Blush', 'Charcoal',
];
...
export interface StudioCategory {
    id: string;
    label: string;
    optionKey: keyof Required<AvatarConfig>;
    values: string[];
    colorKind?: ColorKind;
}
...
export function effectiveHair(config: Required<AvatarConfig>): string {
