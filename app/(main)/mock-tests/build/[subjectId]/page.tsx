        ...
        <div className="flex flex-col min-h-dvh bg-background">
            ...
            <header className="flex items-center gap-3 border-b border-border px-4 py-3 shrink-0">
                ...
                <div className="flex-1 min-w-0">
                    <p className="truncate text-sm font-semibold text-foreground">{subjectName || 'লেসন বেছে নাও'}</p>
                    <p className="text-xs text-muted-foreground">টপিক বেছে নাও</p>
                </div>
                {selectedCount > 0 && (
            ...
            <AnimatePresence>
                {selectedCount > 0 && (
                    <motion.div
                        ...
                        exit={{ y: 60, opacity: 0 }}
                        transition={{ duration: 0.2 }}
                        className="sticky bottom-0 shrink-0 border-t border-border bg-background/95 backdrop-blur-sm px-4 py-4"
                    >
