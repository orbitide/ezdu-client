    ...
    if (error || !profile) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-3 px-4">
                ...
                <p className="text-sm text-muted-foreground">{error || 'প্রোফাইল পাওয়া যায়নি'}</p>
                <button
                    onClick={() => router.back()}
                ...
                <div className="space-y-4">
                    ...
                    {!isOwnProfile && (
                        <button
                            ...
                            className="flex w-full items-center justify-center gap-2 rounded-xl border border-border py-2.5 text-sm font-semibold text-muted-foreground hover:border-ring/40 hover:text-foreground transition-colors disabled:opacity-60"
                        >
                            {followLoading ? (
