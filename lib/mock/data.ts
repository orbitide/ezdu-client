...
export const classes: Class[] = [
  {
    ...
    title: "SSC 27 বোর্ড পরীক্ষা প্রস্তুতি [বিজ্ঞান বিভাগ]",
    level: "SSC",
    thumbnail: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?w=600&h=340&fit=crop",
    subjectCount: 5,
    lessonCount: 32,
    description: "পদার্থবিজ্ঞান, রসায়ন, জীববিজ্ঞান, গণিত ও ইংরেজি — SSC 2027 পরীক্ষার্থীদের জন্য ভিডিও লেকচার, MCQ প্র্যাকটিস ও পূর্ণাঙ্গ মক টেস্টসহ।",
  ...
  },
  {
    ...
    title: "HSC 27 বোর্ড পরীক্ষা প্রস্তুতি [বিজ্ঞান বিভাগ]",
    level: "HSC",
    thumbnail: "https://images.unsplash.com/photo-1507413245164-6160d8298b31?w=600&h=340&fit=crop",
    subjectCount: 6,
    lessonCount: 48,
    description: "পদার্থবিজ্ঞান, রসায়ন, জীববিজ্ঞান ও উচ্চতর গণিত — HSC 2027 পরীক্ষার্থীদের জন্য বিশেষজ্ঞ শিক্ষকদের লাইভ ও রেকর্ডেড ব্যাচ।",
    entitlement: "preview",
    price: 1500,
    enrolledCount: 6200,
    rating: 4.9,
  ...
  },
  {
    ...
    title: "HSC 27 বোর্ড পরীক্ষা প্রস্তুতি [বাণিজ্য বিভাগ]",
    level: "HSC",
    thumbnail: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&h=340&fit=crop",
    subjectCount: 5,
    lessonCount: 40,
    description: "হিসাববিজ্ঞান, ব্যবসায় সংগঠন ও ব্যবস্থাপনা, ফিন্যান্স — HSC 2027 বাণিজ্য বিভাগের পরীক্ষার্থীদের জন্য অনলাইন ব্যাচ।",
    entitlement: "locked",
    price: 1300,
    enrolledCount: 3100,
    rating: 4.7,
  ...
  },
  {
    ...
    title: "দশম শ্রেণি - বাংলা, ইংরেজি ও সাধারণ বিষয় অনলাইন ব্যাচ",
    level: "SSC",
    thumbnail: "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=600&h=340&fit=crop",
    subjectCount: 5,
    lessonCount: 35,
    description: "বাংলা, ইংরেজি, ইতিহাস, ভূগোল ও পৌরনীতি — SSC 2027 মানবিক বিভাগের শিক্ষার্থীদের জন্য সৃজনশীল ও MCQ প্রস্তুতি ব্যাচ।",
    entitlement: "free",
    price: 0,
    enrolledCount: 2800,
    rating: 4.6,
  ...
  },
  {
    ...
    title: "BUET ভর্তি পরীক্ষা প্রস্তুতি ব্যাচ ২০২৭",
    level: "Admission",
    thumbnail: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=600&h=340&fit=crop",
    subjectCount: 4,
    lessonCount: 60,
    description: "পদার্থবিজ্ঞান, রসায়ন, গণিত ও ইংরেজি — BUET ২০২৭ ভর্তি পরীক্ষার জন্য বিগত বছরের প্রশ্ন বিশ্লেষণ ও উচ্চমানের প্র্যাকটিস সেটসহ।",
    entitlement: "preview",
    price: 2000,
    enrolledCount: 1950,
    rating: 4.9,
  ...
  },
  {
    ...
    title: "মেডিকেল ভর্তি পরীক্ষা প্রস্তুতি ব্যাচ ২০২৭",
    level: "Admission",
    thumbnail: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&h=340&fit=crop",
    subjectCount: 4,
    lessonCount: 55,
    description: "জীববিজ্ঞান, রসায়ন, পদার্থবিজ্ঞান ও সাধারণ জ্ঞান — মেডিকেল ২০২৭ ভর্তি পরীক্ষার্থীদের জন্য বিশেষজ্ঞ শিক্ষকদের নিবিড় প্রস্তুতি ব্যাচ।",
    entitlement: "locked",
    price: 1800,
    enrolledCount: 2400,
    rating: 4.8,
  ...
  },
  {
    ...
    title: "গণিত ও বিজ্ঞান অলিম্পিয়াড প্রস্তুতি ব্যাচ",
    level: "Olympiad",
    thumbnail: "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=600&h=340&fit=crop",
    subjectCount: 3,
    lessonCount: 45,
    description: "জাতীয় ও আন্তর্জাতিক গণিত-বিজ্ঞান অলিম্পিয়াডের জন্য সমস্যা সমাধানের কৌশল ও প্রতিযোগিতামূলক গণিতের নিবিড় ব্যাচ।",
    entitlement: "preview",
    price: 1800,
    enrolledCount: 1200,
    rating: 4.9,
  ...
  },
  {
    ...
    title: "IELTS Band 7+ অনলাইন ব্যাচ",
    level: "IELTS",
    thumbnail: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=600&h=340&fit=crop",
    subjectCount: 4,
    lessonCount: 60,
    description: "Listening, Reading, Writing ও Speaking — Academic ও General Training উভয়ের জন্য Band 7+ টার্গেট করা অনলাইন ব্যাচ।",
    entitlement: "preview",
    price: 2200,
    enrolledCount: 3400,
    rating: 4.8,
  ...
  },
  {
    ...
    title: "BCS ও ব্যাংক জব প্রিলিমিনারি মাস্টার ব্যাচ",
    level: "Job Prep",
    thumbnail: "https://images.unsplash.com/photo-1521791136064-7986c2920216?w=600&h=340&fit=crop",
    subjectCount: 5,
    lessonCount: 80,
    description: "বাংলা, ইংরেজি, গণিত, সাধারণ জ্ঞান ও কম্পিউটার — BCS প্রিলিমিনারি ও ব্যাংক জবের জন্য বিগত বছরের প্রশ্ন বিশ্লেষণসহ মাস্টার ব্যাচ।",
    entitlement: "locked",
    price: 2500,
    enrolledCount: 8700,
    rating: 4.7,
  ...
  },
  {
    ...
    title: "পদার্থবিজ্ঞান অলিম্পিয়াড মাস্টার ব্যাচ",
    level: "Olympiad",
    thumbnail: "https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?w=600&h=340&fit=crop",
    subjectCount: 2,
    lessonCount: 36,
    description: "মেকানিক্স, তড়িৎ, আলোকবিজ্ঞান ও আধুনিক পদার্থবিজ্ঞান — BdPhO ও IPhO প্রস্তুতির জন্য উচ্চমানের সমস্যা সমাধান ব্যাচ।",
    entitlement: "locked",
    price: 1600,
    enrolledCount: 680,
    rating: 5.0,
  ...
  },
  {
    ...
    title: "ফ্রিল্যান্সিং ও ডিজিটাল দক্ষতা অনলাইন ব্যাচ",
    level: "Skills",
    thumbnail: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&h=340&fit=crop",
    subjectCount: 4,
    lessonCount: 50,
    description: "Upwork, Fiverr-এ প্রোফাইল তৈরি, ক্লায়েন্ট ম্যানেজমেন্ট, গ্রাফিক ও ওয়েব ডিজাইন — আন্তর্জাতিক মার্কেটপ্লেসে ক্যারিয়ার গড়ার অনলাইন ব্যাচ।",
    entitlement: "preview",
    price: 1400,
    enrolledCount: 5200,
    rating: 4.6,
